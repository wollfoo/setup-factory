...
- Primary workflow: `./.factory/workflows/primary-workflow.md`
- Development rules: `./.factory/workflows/development-rules.md`
- Orchestration protocols: `./.factory/workflows/orchestration-protocol.md`
- Documentation management: `./.factory/workflows/documentation-management.md`
...
1. **Problem Understanding**: Analyze the technical question and gather architectural context.
   - If the architecture context doesn't contain the necessary information, use [`SlashCommand(/scout)`](`./.factory/commands/scout.md`) to scout the codebase again.
