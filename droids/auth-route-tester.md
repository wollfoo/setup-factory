...
description: |
  Authenticated route testing specialist. Use PROACTIVELY after implementing or modifying
  API routes, authentication endpoints, or authorization logic. Tests JWT cookie-based auth,
  route functionality, database operations, and response validation.

  Specializes in:
  - Testing authenticated API endpoints with proper JWT cookies
  - Validating route data handling and database record creation
  - Checking authentication and authorization flows
  - Testing error scenarios and edge cases
  - Reviewing route implementation quality
